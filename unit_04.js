...
function f4() {
   ...
   if(check){
    document.querySelector('.out-4').innerHTML = `${check}`
   } else { document.querySelector('.out-4').innerHTML = `${check}`}
}
...
function f5() {
  ...
  if(check){
    document.querySelector('.out-5').innerHTML = `${check.innerHTML}`
   } else { document.querySelector('.out-5').innerHTML = `${check}`}
}
...
function f7() {
 ...
 } else { document.querySelector('.out-72').innerHTML = 0}
}
...
function f8() {
    document.querySelector('.out-8').innerHTML = '<input type="text" class="i-81"><button class="b-812">This is btn</button>'

    let b81 = document.querySelector('.b-812')
    console.log(b81.innerHTML)
    ...
    //
    document.querySelector('.b-812').onclick = f81
}
...
function f9() {
    ...
    } else { document.querySelector('.out-9').innerHTML = 0}
}
...
function f10() {
    let colour = document.querySelector('.i-10')
    let out = document.querySelector('.out-10')
    out.style.background = colour.value
}
...
function f19() {
   ...
   document.querySelector('.out-19').innerHTML = `${input} ${password}`
}
...
function f20(e) {
    ...
    let name = form.elements['username'].value; // так можно обратиться к элементу внутри формы
    let password = form.elements['password'].value
    document.querySelector('.out-20').innerHTML = `${name} ${password} Well done! 11:42 P.M 06/12/2023 Keep going in this way. You must reach the life you want! It's you from your past`
}
...
function birthday(){
    ...
    document.querySelector('.smthbody').innerHTML = `You were born in ${+date.value} of ${mm} in ${+year.value} year`
}
document.querySelector('.smth1').onclick = birthday
...
function count(){
    ...
    document.querySelector('.secondbody').innerHTML = `Максимальное число - ${max} минимальное число ${min}`
}
document.querySelector('.second1').onclick = count
